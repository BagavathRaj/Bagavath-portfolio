...
import smartbag from './assets/Projects/smartbag.png';
import Profileimg from './assets/Profile/profileimg.jpeg';
      ...
      <div className="flex justify-center gap-6 mb-12">
        {[
          ...
          <a key={idx} href={social.href} className="flex flex-col items-center group">
            <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center text-gray-400 group-hover:bg-accent group-hover:text-black group-hover:shadow-[0_0_20px_#00D1FF] transition-all duration-300">
              {social.icon}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          <div className="relative z-10 w-full aspect-[4/5] rounded-[40px] overflow-hidden border-8 border-white/5 bg-[#111] shadow-2xl">
            <div className="absolute inset-0 bg-cover bg-center"style={{ backgroundImage: `url(${Profileimg})` }}/>
            <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-80" />
            <div className="absolute bottom-10 left-10">
               <h3 className="text-3xl font-black text-white leading-none mb-2 tracking-tighter">AI ENGINEER &<br/><span className="text-accent">DEVELOPER</span></h3>
        ...
        <div>
          <span className="text-accent font-bold tracking-widest uppercase text-[9px] mb-4 block">Professional Background</span>
          ...
          <div className="space-y-8">
            <div className="relative border-l-2 border-white/10 pl-8 space-y-12">
              <div className="relative">
                <div className="absolute -left-[41px] top-1 w-4 h-4 rounded-full bg-accent shadow-[0_0_15px_#00D1FF]" />
                ...
                {USER_DATA.experience.map((exp, idx) => (
                  <div key={idx} className="bg-white/5 p-8 rounded-[24px] border border-white/5 hover:border-[#00D1FF]/30 transition-all">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-[9px] font-black text-accent bg-[#00D1FF]/10 px-3 py-1 rounded-full uppercase">{exp.year}</span>
                    </div>
              ...
              <div className="relative">
                <div className="absolute -left-[41px] top-1 w-4 h-4 rounded-full bg-white/20 border-2 border-accent" />
                ...
                {USER_DATA.education.map((edu, idx) => (
                  <div key={idx} className="bg-white/5 p-8 rounded-[24px] border border-white/5 hover:border-[#00D1FF]/30 transition-all">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-[9px] font-black text-accent bg-white/5 px-3 py-1 rounded-full uppercase">{edu.year}</span>
                    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {USER_DATA.skills.map((skill, idx) => (
          ...
          >
            <div className="text-accent mb-4 flex justify-center opacity-50 group-hover:opacity-100 transition-opacity">
               <Cpu size={32} />
            </div>
  ...
  <section id="projects" className="py-24  bg-[#080808]">
    <div className="max-w-7xl mx-auto px-4 md:px-6">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
        ...
        <a href="https://github.com/repos?q=owner%3A%40me" target="_blank" rel="noopener noreferrer" className="text-white font-black text-[10px] uppercase tracking-[0.2em] hover:text-accent transition-all flex items-center gap-2 border-b border-white/10 pb-2">View Repository <ExternalLink size={12} />
        </a>
      </div>
